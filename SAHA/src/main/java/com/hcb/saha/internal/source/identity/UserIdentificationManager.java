...
public class UserIdentificationManager {
	 ...
	 * What is the point of this class? Isn't the approach,
	 * 1. Listen to movement / sound
	 * 2. When movement / sound is detected - go into user detection mode (turn on face detection)
	 * 3. If face / voice is detected and recognized, propagate to rest of app
	 */
}
